...
{
	class CGolosWallet : CGolosAPI
	{
		#region Constructors
		public CGolosWallet(string strHostname = "127.0.0.1", ushort nPort = 8091) : base(strHostname, nPort)
		{
		}
		#endregion
		...
		//    broadcast: true if you wish to broadcast the transaction (type: bool)
		public JObject convert_gbg(string from, Decimal amount, bool broadcast = true)
		{
			ArrayList arrParams = new ArrayList();
			arrParams.Add(from);
		...
		//Gets the current order book For GBG:GOLOS
		//
		//Parameters:
